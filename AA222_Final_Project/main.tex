...
Martin Zhou implemented the terrain pipeline, global planning stack, and the planner/SCP integration used in the final benchmark.

Sebastian Martinez implemented and refined the rover dynamics model, the JAX-based SCP algorithm, and the supporting trajectory optimization tests.
